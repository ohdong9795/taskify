...
export default function PasswordChangeForm() {
  ...
  return (
    <form className="mobile:w-[28.4] tablet:w-[54.4] flex flex-col ml-[1.7] w-[62] h-[45] bg-white rounded-lg justify-center align-center px-[2.8] justify-around">
      <div className="text-zinc-800 text-[2.4] font-bold font-['Pretendard']">비밀번호 변경</div>
      <div className="flex flex-col">
        <label className="text-zinc-800 text-[1.8] font-medium font-['Pretendard']" htmlFor="CurrentPassword">
          현재 비밀번호
        </label>
        <input
          id="CurrentPassword"
        ...
        />
        <label className="text-zinc-800 text-[1.8] font-medium font-['Pretendard']" htmlFor="NewPassword">
          새 비밀번호
        </label>
        <input
          id="NewPassword"
        ...
        />
        <label className="text-zinc-800 text-[1.8] font-medium font-['Pretendard']" htmlFor="NewPasswordConfirm">
          새 비밀번호 확인
        </label>
        <input
