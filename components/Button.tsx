...
import BackwardWhiteIcon from '../public/images/arrow-backward-white.svg';
import BackwardBlackIcon from '../public/images/arrow-backward-black.svg';
import ForwardIcon from '../public/images/arrow-forward-white.svg';
  ...
  return (
    <div className={contatinerStyle}>
      ...
      <div className="flex items-center">
        ...
        >
          <Image src={BackwardWhiteIcon} alt="뒤로 가기 아이콘" />
        </Button>
        <Button
          variant="secondary"
          customStyles={
        ...
        >
          <Image src={ForwardIcon} alt="앞으로 가기 아이콘" />
        </Button>
      </div>
    </div>
  );
