...
const ModalOpenButton = forwardRef<HTMLButtonElement, ButtonProps>(({ text, handleClick }, ref) => (
  <button
    ref={ref}
    type="button"
    className="flex items-center justify-center gap-3 px-4 py-2 mx-auto mb-4 font-semibold text-white border t:mx-0 bg-violet_5534DA border-gray_D9D9D9 rounded-3xl hover:bg-violet-500"
    onClick={handleClick}
  >
    {text}
